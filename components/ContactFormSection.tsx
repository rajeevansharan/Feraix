...
export default function ContactFormSection() {
  ...
  const validate = () => {
    ...
    // Privacy Validation
    if (!formData.privacy) {
      newErrors.privacy = "Agreement is required";
    }
  ...
  return (
    <section
      id="contact-form"
      className="py-12 sm:py-24 bg-background selection:bg-primary selection:text-white overflow-hidden"
    >
                ...
                {[
                  {
                    ...
                    content:
                      "Feraix Global Technologies, Building 4, Dubai Internet City, PO Box 12345, Dubai, UAE",
                  },
                  {
                    icon: Mail,
                    title: "Email Us",
                    content:
                      "General: hello@feraix.com Support: support@feraix.com",
                  },
                  {
                    icon: Phone,
                    title: "Call Us",
                    content: "Main: +971 4 123 4567 Sales: +971 4 123 4568",
                  },
                  {
                    icon: Clock,
                    title: "Business Hours",
                    content:
                      "Monday - Friday: 9:00 AM - 6:00 PM (GST) Saturday - Sunday: Closed",
                  },
                ].map((item, index) => (
                  <motion.div
                    key={index}
              ...
              <div className="pt-10 border-t border-white/5">
                ...
                >
                  {[
                    {
                      sr: "LinkedIn",
                      svg: "M19 0H5a5 5 0 0 0-5 5v14a5 5 0 0 0 5 5h14a5 5 0 0 0 5-5V5a5 5 0 0 0-5-5zM8 19H5V8h3v11zM6.5 6.732c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zM20 19h-3v-5.604c0-3.368-4-3.113-4 0V19h-3V8h3v1.765c1.396-2.586 7-2.777 7 2.476V19z",
                    },
                    {
                      sr: "X",
                      svg: "M18.244 2H21.5l-7.5 8.57L22 22h-6.828l-5.35-6.91L3.5 22H.243l8.02-9.16L2 2h6.828l4.84 6.29L18.244 2zm-2.4 18h1.9L8.16 4h-2l9.684 16z",
                    },
                    {
                      sr: "Instagram",
                  ...
                  <motion.div variants={fadeInUp} className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      >
                        ...
                        and consent to Feraix processing my personal data.
                      </label>
                    </div>
                    {errors.privacy && (
                      <p className="text-[10px] text-red-500 pl-1">
